function extractCalibrationValues(lines) {
    ...
    lines.forEach((line, index) => {
        ...
        if (firstDigit !== null && lastDigit !== null) {
            ...
            console.log(`Valeur d'étalonnage pour la ligne ${index + 1} : ${calibrationValue}`);
        } else {
            console.log(`Aucun chiffre trouvé dans la ligne ${index + 1}.`);
        }
    });
    console.log(`La somme totale des valeurs d'étalonnage est : ${totalCalibrationValue}`);
}
const lines = [
...
extractCalibrationValues(lines);